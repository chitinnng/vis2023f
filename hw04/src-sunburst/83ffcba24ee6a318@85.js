...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>減少包裝材及文宣印製或是使用無毒媒材、再生材料、廢物利用素材等，是大多數人會用來減少碳排放的行動。</li>
    <li>在少部分人提出的減碳行動中，可以發現宣導環保相關觀念也是其中一種方式</li>
    <li>對於需要長期開放展覽的美術館，節約能源是他們著要考量的減少碳排放量策略</li>
  </ul>
</h3>`
)}
...
d3
  ...
  .range(["#7495AF","#C7C7E2","#DC9FB4","#D4DDFC","#97CBFF","#CDB6EC"])
  .unknown("#F7CACA")
)}
