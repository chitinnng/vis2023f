...
### 從上圖中，我們可以看出：
- ###  在本次統計中，北部的受訪者最多。
- ###  對於以數位方式舉行的藝文展覽，因敘述不夠具體或內容不夠詳細，導致不少人不能確定此方法的可行性。`
)}
...
d3
  ...
  .range(["#7495AF","#C7C7E2","#DC9FB4","#D4DDFC","#97CBFF","#CDB6EC","#ECEBE4", "#D3D5D4"])
  .unknown("#F7CACA")
)}
...
md`#### 參考 https://observablehq.com/d/d5898113bb2d8ebd`
)}
